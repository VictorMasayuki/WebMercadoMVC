...
namespace WebMercadoMVC.Controllers
{
    public class ComprasController : Controller
    {
        ...
        {
            var contexto = _context.Compras.Include(c => c.cliente).Include(c => c.produto);
        ...
        public async Task<IActionResult> Create([Bind("id,clienteid,produtoid,quantidaderequisitada")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,clienteid,produtoid,quantidaderequisitada")] Compra compra)
        {
            if (id != compra.id)
            {
                return NotFound();
